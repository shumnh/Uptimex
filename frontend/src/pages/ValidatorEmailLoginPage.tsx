...
function ValidatorEmailLoginPage() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.user.role !== 'validator') {
          setError('This account is not registered as a validator. Please use the website owner login.');
          return;
        }
          ...
          <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-10 border border-white/50 shadow-2xl">
            <div className="text-center mb-10">
              ...
              <p className="text-xl text-slate-600 leading-relaxed font-medium">
                Sign in to your validator account with email
              </p>
              <div className="mt-6 inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl">
                ...
                <span className="text-green-700 text-sm font-bold">
                  Validator Portal • Secure Access
                </span>
              </div>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="Enter your validator email"
                    required
                  />
                ...
                <span className="relative z-10 flex items-center justify-center">
                  {isLoggingIn ? (
                    ...
                    <>
                      ...
                      <span className="text-lg">Sign In as Validator</span>
                    </>
                  )}
                </span>
...
export default ValidatorEmailLoginPage; 