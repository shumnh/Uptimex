...
function ValidatorEmailRegisterPage() {
    ...
    try {
      ...
      const response = await fetch(`${API_ENDPOINTS.BASE}/api/auth/register`, {
        ...
        body: JSON.stringify({
          ...
          role: 'validator' // Set role as validator
        }),
      });
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-10 border border-white/50 shadow-2xl">
            <div className="text-center mb-10">
              <div className="w-24 h-24 bg-gradient-to-r from-green-600 to-emerald-600 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl">
              ...
              <p className="text-xl text-slate-600 leading-relaxed font-medium">
                Create your validator account and start earning
              </p>
              <div className="mt-6 inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl">
                ...
                <span className="text-green-700 text-sm font-bold">
                  Validator Registration • Earn SOL Rewards
                </span>
              </div>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-4 pl-12 bg-white border-2 border-slate-200 rounded-xl focus:outline-none focus:border-green-500 transition-all duration-300"
                ...
                <span className="relative z-10 flex items-center justify-center">
                  {isRegistering ? (
                    ...
                    <>
                      ...
                      <span className="text-lg">Create Validator Account</span>
                    </>
                  )}
                </span>
            ...
            <div className="text-center mt-6">
              <p className="text-slate-600 mb-4 font-medium">
                Already have a validator account?
              </p>
              <Link 
                to="/validator-email-login"
                className="inline-flex items-center justify-center px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 transform hover:-translate-y-1"
              >
...
export default ValidatorEmailRegisterPage; 